...
<form id="createVideo" method="POST" action="{{ route('video-clips.store') }}" enctype="multipart/form-data">
    @csrf
        ...
        const dropzoneMulti = new Dropzone('#dropzone-video', {
            ...
            success: function(file, response) {
                ...
                hiddenInputsContainer.innerHTML +=
                    ...
                    `<input type="hidden" name="video_titles[]" value="${file.name}" data-path="${response.path}">`;
            },
            removedfile: function(file) {
                const hiddenInputsContainer = file.previewElement.closest('form').querySelector('.hidden-inputs');
                hiddenInputsContainer.querySelectorAll(`input[data-path="${file.previewElement.dataset.path}"]`).forEach(input => input.remove());
